...
#lower_range=np.array([]) # update the lower values of calibration results in the array
#upper_range=np.array([]) # update the upper values of calibration results in the array


#Known_distance = 13.0  # Put known object distance
#Known_width = 3.0   # Put known object width
